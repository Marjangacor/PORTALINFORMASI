...
if (isset($_POST['submit'])) {
    ...
    $folder = "../../dashboard/guru/perpusguru/fotobuku/";
   ...
   $query = "INSERT INTO perpustakaan (judul, blurb, tanggal, gambar, kategori, pengarang, status)
    ...
    if (mysqli_query($conn, $query)) {
        header("Location: perpusadmin.php"); // Redirect jika berhasil
        exit();
    } else {
        header("Location: tambah.php?error=1"); // Redirect jika gagal
        exit();
    }
}
?>
...
<body>
  ...
  <div class="tambah-box">
    ...
    <form action="" method="POST" enctype="multipart/form-data">
      ...
      <div class="tombol">
        <a href="perpusadmin.php"><button type="button">Kembali</button></a>
