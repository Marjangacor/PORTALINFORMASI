...
<head>
  ...
  <link rel="stylesheet" href="isiperpus.css"> 
</head>
<body>
  <nav>
  <a href="perpusadmin.php" class="kembali"> kembali</a>
 </nav>
  ...
  <!-- Gambar Buku -->
  <div class="thumbnail" style="background-image: url('../../dashboard/guru/perpusguru/fotobuku/<?= htmlspecialchars($data['gambar']) ?>');"></div>
