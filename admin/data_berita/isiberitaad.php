...
<head>
  ...
  <link rel="stylesheet" href="isiberitaad.css">
</head>
<body>

<a href="beritaadmin.php" class="kembali">&lt; kembali</a>

<!-- Konten Berita -->
<h2><?= htmlspecialchars($data['judul']) ?></h2>
<div class="thumbnail" ><img src="../../dashboard/guru/berita/fotoberita/<?= htmlspecialchars($data['gambar']) ?>" alt=""></div>
