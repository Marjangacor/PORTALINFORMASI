...
<head>
  ...
  <link rel="stylesheet" href="berandagr.css"/>
</head>
<body>
...
<div class="container">
  ...
  <aside class="sidebar">
    ...
    <nav>
      <a href="berandaguru.php" class="active">Beranda</a>
    ...
    <div class="kategori">
      ...
      foreach ($kategori as $kat) {
          ...
          while ($row = $result->fetch_assoc()) {
              ...
              echo "
                <a href='../berita/isiberita.php?ID_BERITA=$id' class='card'>
                  <img src='../berita/fotoberita/$gambar' alt='$judul'/>
                  <div class='card-text'>
                    <h3>$judul</h3>
                  </div>
                </a>
